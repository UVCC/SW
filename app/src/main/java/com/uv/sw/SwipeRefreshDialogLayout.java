...
/**
 * SwipeRefreshDialogLayout
 */

public class SwipeRefreshDialogLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshDialogLayout.class.getSimpleName();
    ...
    SwipeRefreshDialogLayout.OnRefreshListener mListener;
    ...
    /**
     * Simple constructor to use when creating a SwipeRefreshDialogLayout from code.
     *
     * @param context
     */
    public SwipeRefreshDialogLayout(@NonNull Context context) {
        this(context, null);
    }

    /**
     * Constructor that is called when inflating SwipeRefreshDialogLayout from XML.
     *
     * @param context
     * @param attrs
     */
    public SwipeRefreshDialogLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
     ...
     * gesture.
     */
    public void setOnRefreshListener(@Nullable SwipeRefreshDialogLayout.OnRefreshListener listener) {
        mListener = listener;
    }
